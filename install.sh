...
sleep 3
sudo apt install neofetch zsh git curl wget flatpak net-tools kitty bat gedit lsd golang nmap wireshark netcat-traditional chromium unrar openjdk-21-jre zip python3 python3-pip python3-setuptools pipx cmatrix bspwm sxhkd build-essential cmake pkg-config polybar libxcb1-dev libxcb-xkb-dev libxcb-randr0-dev libxcb-cursor-dev libxcb-xinerama0-dev libxcb-icccm4-dev libxcb-ewmh-dev libxcb-xrm0 libxcb-xrm-dev libx11-xcb-dev libxft-dev libfontconfig1-dev python3-sphinx libcairo2-dev libfontconfig1-dev libasound2-dev libcurl4-openssl-dev libmpdclient-dev libiw-dev libpulse-dev libxcb-composite0-dev xcb-proto python3-xcbgen libjsoncpp-dev libjsoncpp-dev -y
